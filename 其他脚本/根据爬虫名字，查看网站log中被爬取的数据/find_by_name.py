...
# 输入的关键词和基础网址
keyword_list = ["Doubao",'DeepSeek','YuanBao']
base_url = "https://www.bdfyx.net/"
for keyword in keyword_list:
    # 打开并读取日志文件
    with open(r"D:\sort\ai爬虫统计\bdfyx.net 4月到现在\bdfyx.net.log", "r") as file:
    ...
    df.to_excel(rf"D:\sort\ai爬虫统计\bdfyx.net 4月到现在\{keyword}统计.xlsx", index=False)
